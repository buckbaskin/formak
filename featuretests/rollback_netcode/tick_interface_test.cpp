...
/// working correctly) while running with rollback.
...
formak::runtime::ManagedFilterOptions synchronization_options{
    .synchronization = formak::runtime::Synchronization::ROLLBACK,
};
